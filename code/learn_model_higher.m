function [results_model,results_stepwise]=learn_model_higher(xTrain,source,target,T)
...
height(target_terms),...
height(common_terms),...
corr(mdl_source.Coefficients.Estimate(idx_source),mdl_target.Coefficients.Estimate(idx_target),'type','Spearman')];
