...
source_hardware = operation_time_feature20_3763(:,1); % write workload
target_hardware = operation_time_feature3_3763(:,1);
source_hardware1 =  operation_time_feature20_3763(:,3); % read workload
target_hardware1 = operation_time_feature3_3763(:,3);

source_workload = operation_time_feature7_3763(:,1);
target_workload = operation_time_feature7_3763(:,3);
source_workload1 = operation_time_feature7_3763(:,9);
target_workload1 = operation_time_feature7_3763(:,10);

source_version = operation_time_feature4_3190(:,1);
target_version = operation_time_feature6_3763(:,1);

source_workload_version = operation_time_feature4_3190(:,3);
target_workload_version = operation_time_feature6_3763(:,1);

source_hardware_workload_version = operation_time_feature4_3190(:,3);
target_hardware_workload_version = operation_time_feature20_3763(:,1);

% determining invalid configurations
idx_invalid_source_hardware = (source_hardware>=1000);
idx_invalid_target_hardware = (target_hardware>=1000);
idx_valid_hardware = ~idx_invalid_source_hardware & ~idx_invalid_target_hardware;

idx_invalid_source_hardware1 = (source_hardware1>=1000);
idx_invalid_target_hardware1 = (target_hardware1>=1000);
idx_valid_hardware1 = ~idx_invalid_source_hardware1 & ~idx_invalid_target_hardware1;

idx_invalid_source_workload = (source_workload>=1000);
idx_invalid_target_workload = (target_workload>=1000);
idx_valid_workload = ~idx_invalid_source_workload & ~idx_invalid_target_workload;

idx_invalid_source_workload1 = (source_workload1>=1000);
idx_invalid_target_workload1 = (target_workload1>=1000);
idx_valid_workload1 = ~idx_invalid_source_workload1 & ~idx_invalid_target_workload1;

idx_invalid_source_version = (source_version>=1000);
idx_invalid_target_version = (target_version>=1000);
idx_valid_version = ~idx_invalid_source_version & ~idx_invalid_target_version;

idx_invalid_source_workload_version = (source_workload_version>=1000);
idx_invalid_target_workload_version = (target_workload_version>=1000);
idx_valid_workload_version = ~idx_invalid_source_workload_version & ~idx_invalid_target_workload_version;

idx_invalid_source_hardware_workload_version = (source_hardware_workload_version>=1000);
idx_invalid_target_hardware_workload_version = (target_hardware_workload_version>=1000);
...
% calculate the measurements noise: NOTE: only 1 measurement
...
input.data = [corr_pear_hardware kl_hardware corr_spear_hardware top_per_intersect_hardware bottom_per_intersect_hardware ttest_hardware corr_tree_hardware results_stepwise_hardware ratio_invalid_source_hardware ratio_invalid_target_hardware ratio_invalid_hardware;
corr_pear_hardware1 kl_hardware1 corr_spear_hardware1 top_per_intersect_hardware1 bottom_per_intersect_hardware1 ttest_hardware1 corr_tree_hardware1 results_stepwise_hardware1 ratio_invalid_source_hardware1 ratio_invalid_target_hardware1 ratio_invalid_hardware1;
corr_pear_workload kl_workload corr_spear_workload top_per_intersect_workload bottom_per_intersect_workload ttest_workload corr_tree_workload results_stepwise_workload ratio_invalid_source_workload ratio_invalid_target_workload ratio_invalid_workload;
corr_pear_workload1 kl_workload1 corr_spear_workload1 top_per_intersect_workload1 bottom_per_intersect_workload1 ttest_workload1 corr_tree_workload1 results_stepwise_workload1 ratio_invalid_source_workload1 ratio_invalid_target_workload1 ratio_invalid_workload1;
corr_pear_version kl_version corr_spear_version top_per_intersect_version bottom_per_intersect_version ttest_version corr_tree_version results_stepwise_version ratio_invalid_source_version ratio_invalid_target_version ratio_invalid_version;
...
input.tableRowLabels = {'h','w','v','wv','hwv'};
...
input.dataFormat = {'%.1f',20}; % three digits precision for first two columns, one digit for the last
